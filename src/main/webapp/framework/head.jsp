...
<div class="header navbar navbar-inverse navbar-fixed-top" style="height: 61px;z-index: 1;">
	...
	<div class="navbar-inner" style="height: 50px;z-index: 3;">
		<div class="container-fluid">
			...
			<div style="font-size: 24px;color: #FFFFFF;padding-left: 8px;padding-top: 5px;float: left;font-weight:bold;">正大鸡场管理系统</div>
			...
			<ul class="nav pull-right">
				<li class="dropdown user">
					<div style="width:190px;height:45px;z-index: 2;">
						...
						<iframe  name="weather_inc" src="http://i.tianqi.com/index.php?c=code&id=12&color=%23FFFFFF&icon=4&num=1"  width="190" height="45" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
					</div>
				</li>
