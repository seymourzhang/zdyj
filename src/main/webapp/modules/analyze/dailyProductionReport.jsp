...
<div id="page-content" class="clearfix" style="padding-top: 10px;">
    <div class="row-fluid">
        <div class="span12">
            ...
            <iframe id="iframe_tab_1" name="inStockForm" width="300%" height="710" frameborder="no" allowtransparency="yes" src="">
            </iframe>
        </div>
...
<script type="text/javascript" src="<%=path%>/modules/analyze/js/dailyProductionReport.js"></script>
<!-- 确认窗口 -->
