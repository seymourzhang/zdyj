...
var humidity = new Array();//目标湿度

<c:forEach items="${HumidityReport}" var="hum">
	xNames.push('${hum.time }点');
	humidity.push(${hum.humidity });
</c:forEach>
</script>
...
<!--                                                                  <option value="${farm.id }" <c:if test="${pd.house_id==house.id}">selected</c:if>>${house.house_name}</option> -->
<!-- 			                                                 </c:forEach> -->
<!-- 															</c:if> -->
<!-- 														</select> -->
<!-- 													</div> -->
...
<%-- 			                                                 </c:if> --%>
												...
												<div class="control-group">
													...
													<div class="controls" style="margin-left: 35px;">
														<div class="input-append date date-picker" data-date-format="yyyy-mm-dd" data-date-viewmode="years" data-date-minviewmode="months">
															...
															<input class="m-wrap  span11 m-ctrl-medium date-picker " type="text" name="queryTime" id="queryTime" /><span class="add-on"><i class="icon-calendar"></i></span>
											...
											<div style="margin-left: 80px; float:left">
						                          <input id="btn" type="button" onclick="humiUrl();" value="对比">
									        </div>
											<!-- 对比 -->
							...
							<!-- 对比图 -->
<!-- 							<div id="humiRep" style="display:none;"> -->
							<div id="humiRep" style="display:none;" class="portlet box blue1">
								<div class="portlet-title">
									<div class="caption">
...
<script type="text/javascript" src="<%=path%>/modules/report/js/humidityReport.js"></script>
</body>
</html>
