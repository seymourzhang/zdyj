...
var co2 = new Array();//实际co2
var highAlarmCo2 = new Array();//高报co2

<c:forEach items="${CarbonReport}" var="cr">
	xNames.push('${cr.time }点');
	co2.push(${cr.co2});  //实际co2
	highAlarmCo2.push(${cr.high_alarm_co2}); //高报co2
</c:forEach>
</script>
...
<%-- 			                                                 </c:if> --%>
											...
											<!-- 对比 -->
										       <div style="margin-left: 80px; float:left">
						                          <input id="btn" type="button" onclick="carbonUrl();" value="对比">
									           </div>
											<!-- /对比 -->
							...
							<div id="carbonRep" style="display:none;" class="portlet box blue1">
								<div class="portlet-title">
									<div class="caption">
...
<script type="text/javascript" src="<%=path%>/modules/report/js/carbonReport.js"></script>
</body>
</html>
